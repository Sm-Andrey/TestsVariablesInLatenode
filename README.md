...
1. Создание сценария
   Предусловие: авторизоваться тестовым пользователем
    - Нажать кнопку Create a new scenario
      Ожидаемый результат: на странице есть хлебные крошки с именем сценария Untitled
      Постусловие: удалить сценарий

2. Редактировать существующий сценарий, путем добавления ноды
   Предусловие: авторизоваться тестовым пользователем и создать сценарий
    - Нажать на иконку Add Node
    - Выбрать Trigger on Schedule
      Ожидаемый результат: на странице есть иконка с названием Trigger on Schedule
      Постусловие: удалить ноду

3. Проверка запуска активности ноды и остановки этой активности
   Предусловие: авторизоваться тестовым пользователем и создать сценарий
    - Перейти на страницу со сценариями
    - Нажать на три точки справа от названия сценария и выбрать Enable
      Ожидаемый результат: статус активности сменился с Pause на Active
    - Нажать на три точки справа от названия сценария и выбрать Disable
      Ожидаемый результат: статус активности сменился с Active на Pause
      Постусловие: удалить созданные папки и сценарии

4. Проверка удаления созданого сценария
   Предусловие: авторизоваться тестовым пользователем и создать сценарий
    - Перейти на страницу со сценариями
    - Нажать на три точки справа от названия сценария и выбрать Delete
    - Подтвердить удаление нажав на кнопку Delete
      Ожидаемый результат: сценарий удален со страницы
      Постусловие: удалить созданные папки и сценарии

5. Проверка создания папки и удаление папки.
   Предусловие: авторизоваться тестовым пользователем и создать сценарий
    - Перейти на страницу со сценариями
    - Нажать на кнопку Add new folder
    - Ввести название папки
    - Нажать Save
    - Нажать на три точки справа от названия папки и выбрать Delete
    - Подтвердить удаление нажав на кнопку Delete
      Ожидаемый результат: папка удалена со страницы
      Постусловие: удалить созданные папки и сценарии

6. Проверка перемещения сценария между создаными папками.
   Предусловие: - авторизоваться тестовым пользователем
   - создать сценарий
   - создать две папки
   - переместить в одну папку сеценарий
   шаги:
   - Перейти на страницу со сценариями
   - Нажать на три точки справа от названия папки и выбрать Move Scenario
   - Нажать на поле select чтобы раскрылся список папок
   - Нажать на иконку с плюсом
   - Выбрать вторую папку
   - Нажать Save
   Ожидаемый результат: сценарий переместился из одной папки в другую
   Постусловие: удалить созданные папки и сценарии

7. Проверка создания папки и сценария внутри и удаление этой папки.
   Предусловие: авторизоваться тестовым пользователем и создать сценарий
    - Перейти на страницу со сценариями
    - Нажать на кнопку Add new folder
    - Ввести название папки
    - Нажать Save
    - Нажать на три точки справа от названия папки и выбрать Add new scenario
    - Перейти на страницу со сценариями
    - Нажать на три точки справа от названия папки и выбрать Delete
    - Подтвердить удаление нажав на кнопку Delete
    - Подтвердить удаление папки со сценариями
      Ожидаемый результат: папка удалена со страницы
      Постусловие: удалить созданные папки и сценарии

8. Проверка экпорта сценария.
   Предусловие: авторизоваться тестовым пользователем и создать сценарий
    - Перейти на страницу со сценариями
    - Нажать на три точки справа от названия сценария и выбрать Export scenario
      Ожидаемый результат: скачался файл в формате json в папку установленную по умолчанию браузером для загрузки
      Постусловие: удалить созданные папки и сценарии

9. Проверка экпорта папки.
   Предусловие: авторизоваться тестовым пользователем и создать сценарий
    - Перейти на страницу со сценариями
    - Нажать на кнопку Add new folder
    - Ввести название папки
    - Нажать Save
    - Нажать на три точки справа от названия сценария и выбрать Move Scenario
    - Нажать на поле select чтобы раскрылся список папок
    - Нажать на иконку с плюсом
    - Выбрать созданную папку
    - Нажать Save
    - Нажать на три точки справа от названия папки и выбрать Export folder
    - Нажать Ready
      Ожидаемый результат: скачался архив в формате zip в папку установленную по умолчанию браузером для загрузки
      Постусловие: удалить созданные папки и сценарии

10. Проверка импорта сценария.
    Предусловие: авторизоваться тестовым пользователем и создать сценарий, подготовить файл сценария в формате json
    - Перейти на страницу со сценариями
    - Нажать на кнопку Add new folder
    - Ввести название папки
    - Нажать Save
    - Нажать на три точки справа от названия сценария и выбрать Import a folder or scenario
    - Выбрать подготовленный файл в формате json
      Ожидаемый результат: в списке появился импортированный сценарий
      Постусловие: удалить созданные папки и сценарии

11. Проверка импорта папки.
    Предусловие: авторизоваться тестовым пользователем и создать сценарий, подготовить архив папки в формате zip
    - Перейти на страницу со сценариями
    - Нажать на кнопку Add new folder
    - Ввести название папки
    - Нажать Save
    - Нажать на три точки справа от названия сценария и выбрать Import a folder or scenario
    - Выбрать подготовленный архив папки в формате zip
      Ожидаемый результат: в списке появился импортированная папка
      Постусловие: удалить созданные папки и сценарии